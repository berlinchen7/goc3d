...
go run cmumocap.go -i /Users/berlin/go/src/github.com/berlin/goc3d/cmumocap/c3d_data/"$subject"_"$trial".c3d -o /Users/berlin/go/src/github.com/berlin/goc3d/cmumocap/csv_data/"$subject"_"$trial".csv -l "$labels" 

#Convert csv file to animation (where most of the time is spent):
python csv_to_mov.py -csv /Users/berlin/go/src/github.com/berlin/goc3d/cmumocap/csv_data/"$subject"_"$trial".csv \
...
# ffmpeg -i output.mov -filter:v "setpts=8.0*PTS" output_slow.mov #1/8.0 times as fast
